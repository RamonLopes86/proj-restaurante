import estiloNos from "../pgsobre-sobreNos/sobreNos.module.css"



export default function TxNos(){
    return(

        <section className={estiloNos.box_texto}>

                <h2>Sobre Nós</h2>
                <h5>Nós simplismente Amamos sorvete!</h5>
